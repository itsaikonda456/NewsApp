...
const Navbar = (props) => {
  ...
  return (
    <div>
      ...
      {/* Login Modal - FIXED: Removed nested h3 inside h5 */}
            ...
            <div className="modal-body">
              <form onSubmit={handleSignupSubmit}>
                <div className="mb-3">
                  ...
                  <input type="email" className="form-control" id="signupEmail" name="signupEmail" required />
                </div>
                <div className="mb-3">
                  <label htmlFor="signupPassword" className="form-label">Password</label>
                  <input type="password" className="form-control" id="signupPassword" name="signupPassword" required />
                </div>
                <div className="mb-3">
                  <label htmlFor="signupConfirmPassword" className="form-label">Confirm Password</label>
                  <input type="password" className="form-control" id="signupConfirmPassword" name="signupConfirmPassword" required />
                </div>
